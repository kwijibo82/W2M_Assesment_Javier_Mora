...
describe('HeroEditComponent', () => {
  ...
  let mockActivatedRoute,
    mockHeroService: {
      getHeroById: {
        and: {
          returnValue: (arg0: Observable<{ id: number; name: string }>) => void;
        };
      };
      addHero: { and: { returnValue: (arg0: Observable<object>) => void } };
      updateHero: { and: { returnValue: (arg0: Observable<object>) => void } };
      deleteHero: { and: { returnValue: (arg0: Observable<object>) => void } };
    },
    mockNotificationService: { showSuccess: unknown; showError: unknown },
    mockRouter: { navigate: unknown },
    mockDialog: {
      open: {
        and: {
          returnValue: (arg0: {
